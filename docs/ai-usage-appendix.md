...
Note: The HA instance was unsuccesful, as my device was not compatible with Docker. However, with more time I would debug and create a simulation to the test the HA config.
